...
interface AuthorisationSpi<T> {
     ...
     */
    SpiResponse<VoidResponse> requestAuthorisationCode(String psuId, SpiScaMethod scaMethod, T businessObject, AspspConsentData aspspConsentData);
     ...
     * @return Return a positive or negative response as part of SpiResponse
     */
    SpiResponse<VoidResponse> verifyAuthorisationCodeAndExecuteRequest(SpiScaConfirmation spiScaConfirmation, T businessObject, AspspConsentData aspspConsentData);
}
